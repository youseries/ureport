 ...
 * @since 2020年5月29日
 */
public class SelectMultipleInputComponent extends InputComponent {
	...
	String inputHtml(RenderContext context) {
		...
		sb.append("<select style=\"padding:3px;height:28px\" id='"+context.buildComponentId(this)+"' name='"+name+"' class='selectpicker form-control' multiple>");
